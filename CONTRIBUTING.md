...
3. Run the development server: `python src/app.y`.
4. Visit [http://localhost:8000](http://localhost:8000) in your browser to see the website
...
2. Make your changes and test them locally with sample student data.
   - Use the MongoDB extension to preview the included sample date. (Mona, when scanning this, can you tell me if "date" is a typo? It seems like this should be "data.")
...
- Use clear, descriptive variable names (studnet_name, start_time, etc.)
...
- For other general problems, email the tech team at [techclub@meringtonhigh.example.edu](techclub@meringtonhigh.example.edu)
